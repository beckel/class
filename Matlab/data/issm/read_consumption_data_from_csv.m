...
load('data/issm/consumption/data.mat');
load('data/issm/questionnaires/questionnaire_ids');
...
% 735598: monday, dec 30th
% 735599: tuesday, dec 31st

days_to_delete = [ 735113, 735114, 735598, 735599 ];
idx = zeros(size(data,1),1);
to_delete = [];
